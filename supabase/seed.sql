...
declare
  ...
  seed_data jsonb := '[
    ...
    {"nickname":"별똥별","dept":"바이오로직스학과","grade":2,"gender":"female","mbti":"ISTJ","one_liner":"운동 좋아해요","self_traits":["조용함","섬세함"],"desired_traits":["차분함","섬세함"],"interests":["운동","독서"],"activities":["산책·러닝"],"food":["매운 음식"],"music":["재즈"],"conv":"제가 먼저 연락할게요","seeking":["male"],"grades":[2,3]},
    {"nickname":"산책자","dept":"약학과","grade":3,"gender":"male","mbti":"ISTJ","one_liner":"러닝 같이 해요","self_traits":["차분함","섬세함"],"desired_traits":["조용함","섬세함"],"interests":["운동","독서","사진"],"activities":["산책·러닝","사진 촬영"],"food":["매운 음식"],"music":["재즈","팝"],"conv":"제가 먼저 연락할게요","seeking":["female"],"grades":[1,2,3]},
    ...
    {"nickname":"민들레","dept":"바이오로직스학과","grade":3,"gender":"female","mbti":"ISFJ","one_liner":"스터디 같이 해요","self_traits":["섬세함","조용함"],"desired_traits":["차분함","다정함"],"interests":["스터디","독서"],"activities":["산책·러닝"],"food":["디저트"],"music":["재즈"],"conv":"편한 대로 해요","seeking":["male","any"],"grades":[2,3,4]},
    {"nickname":"단풍","dept":"약학과","grade":2,"gender":"male","mbti":"ISFJ","one_liner":"조용한 카페 좋아해요","self_traits":["섬세함","다정함"],"desired_traits":["섬세함","조용함"],"interests":["카페","독서"],"activities":["카페 투어"],"food":["디저트","카페 투어"],"music":["재즈","클래식"],"conv":"편한 대로 해요","seeking":["female"],"grades":[2,3]},
